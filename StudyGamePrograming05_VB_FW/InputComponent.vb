...
Public Class InputComponent
    ...
    End Sub
    Public Function GetForwardKey() As Key
        Return mFwdKey
    End Function
    Public Sub SetForwardKey(ByVal key As Key)
        mFwdKey = key
    End Sub
    Public Function GetBackwardKey() As Key
        Return mBwdKey
    End Function
    Public Sub SetBackwardKey(ByVal key As Key)
        mBwdKey = key
    End Sub
    Public Function GetClockwiseKey() As Key
        Return mCwsKey
    End Function
    Public Sub SetClockwiseKey(ByVal key As Key)
        mCwsKey = key
    End Sub
    Public Function GetCounterClockwiseKey() As Key
        Return mCCwsKey
    End Function
    Public Sub SetCounterClockwiseKey(ByVal key As Key)
        mCCwsKey = key
    End Sub
